...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2019 at 06:37 PM
...
--
-- Table structure for table `daftar_distribusi`
--

CREATE TABLE `daftar_distribusi` (
...
('340007093', 'a', 'a', 'mahasiswa-1234', 'mahasiswa647236283234bfbjed23', 'Guest'),
('340056728', 'ahmad.arafat', 'ahmad.arafat', 'mursit-12345', 'mumu2937412912zzzz', 'Admin');
...
--
-- Table structure for table `master_cetak`
--

CREATE TABLE `master_cetak` (
  `id_cetak` int(11) NOT NULL,
  `id_publikasi` int(11) NOT NULL,
  `file_publikasi` varchar(200) NOT NULL,
  `file_cover` varchar(200) NOT NULL,
  `keterangan_cetak` varchar(200) NOT NULL,
  `id_uploader` varchar(9) NOT NULL,
  `date` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `master_cetak`
--

INSERT INTO `master_cetak` (`id_cetak`, `id_publikasi`, `file_publikasi`, `file_cover`, `keterangan_cetak`, `id_uploader`, `date`) VALUES
(1, 1, 'publikasi20190624180548.pdf', 'cover20190624180548.pdf', 'dsadsada', '340056728', '0000-00-00'),
(2, 2, 'publikasi20190624181527.pdf', 'cover20190624181527.pdf', 'dasdas', '340056728', '0000-00-00'),
(3, 1, 'publikasi20190624183144.rar', 'cover20190624183144.rar', 'sasdsadsa', '340056728', '0000-00-00');
...
--
-- Table structure for table `master_instansi_distribusi`
--

CREATE TABLE `master_instansi_distribusi` (
  `id_instansi` int(11) NOT NULL,
  `nama_instansi` varchar(200) NOT NULL,
  `alamat_instansi` text NOT NULL,
  `internal_or_no` tinyint(1) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `master_instansi_distribusi`
--

INSERT INTO `master_instansi_distribusi` (`id_instansi`, `nama_instansi`, `alamat_instansi`, `internal_or_no`) VALUES
(1, 'Bidang IPDS', 'Jl. Boulevard No. 1 Kendari', 1),
(2, 'Dinas Tanaman Pangan dan Hortikultura', 'jl.Boulevard No 1', 2);
...
CREATE TABLE `master_publikasi` (
  ...
  `id_editor_ipds` varchar(9) NOT NULL,
  `id_pemeriksa_bidang` varchar(9) NOT NULL,
  `status_cetak` int(1) NOT NULL,
  `status_distribusi` int(1) NOT NULL,
  `status_periksa_bidang` int(1) NOT NULL,
  `status_edit_publikasi` int(1) NOT NULL,
  `kirim_pengingat_penyusun_publikasi` date NOT NULL,
  `kirim_pengingat_pemeriksa_bidang` date NOT NULL,
  `kirim_pengingat_editor_publikasi` date NOT NULL,
  `kirim_pengingat_pimpinan` date NOT NULL,
  `file_cover` varchar(200) NOT NULL,
...
INSERT INTO `master_publikasi` (`id_publikasi`, `nama_publikasi`, `tgl_upload`, `tgl_rilis`, `tgl_periksa_bidang`, `tgl_periksa_ipds`, `id_penyusun`, `id_bidang`, `tahun`, `id_editor_ipds`, `id_pemeriksa_bidang`, `status_cetak`, `status_distribusi`, `status_periksa_bidang`, `status_edit_publikasi`, `kirim_pengingat_penyusun_publikasi`, `kirim_pengingat_pemeriksa_bidang`, `kirim_pengingat_editor_publikasi`, `kirim_pengingat_pimpinan`, `file_cover`, `file_pdf`) VALUES
(1, 'Statitik Kesejahteraan Rakyat', '2019-04-09', '2019-04-09', '2019-04-09', '2019-04-09', '340056728', '1', 2019, '', '0', 0, 0, 0, 0, '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00', '0', ''),
(2, 'Statistik Nilai Tukar Petani Provinsi Sulawesi Tenggara 2018', '2019-11-21', '2019-11-21', '2019-11-26', '2019-11-21', '340056158', '1', 2019, '', '0', 0, 0, 0, 0, '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00', '0', ''),
(3, 'Direktoi Desa Provinsi Sulawesi Tenggara 2018', '2019-08-27', '2019-05-29', '2019-06-28', '2019-05-23', '340009536', '1', 2019, '', '0', 0, 0, 0, 0, '0000-00-00', '0000-00-00', '0000-00-00', '0000-00-00', '0', '');

-- --------------------------------------------------------

--
-- Table structure for table `master_publikasi_non_arc`
--

CREATE TABLE `master_publikasi_non_arc` (
  `id_publikasi` int(11) NOT NULL,
  `nama_publikasi` varchar(200) NOT NULL,
  `tgl_rilis` date NOT NULL,
  `file_cover` varchar(200) NOT NULL,
  ...
  `status_cetak` int(1) NOT NULL,
  `status_distribusi` int(1) NOT NULL,
  `di_bidang` char(2) NOT NULL,
  `id_penyusun` varchar(9) NOT NULL,
  `id_editor_penyusun` varchar(9) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Table structure for table `transaksi_download`
--

CREATE TABLE `transaksi_download` (
  `id_download_transaksi` int(11) NOT NULL,
  `tanggal_download` datetime NOT NULL,
  `niplama` varchar(9) NOT NULL,
  `id_transaksi_publikasi` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(57, 1, 'gambar20190623152134.rar', 'cobacoba', '340056728', 1, '2019-06-23 21:21:34');
...
--
-- Indexes for table `daftar_distribusi`
--
ALTER TABLE `daftar_distribusi`
  ADD KEY `instansi` (`id_instansi`),
  ADD KEY `publikasi` (`id_publikasi`);
...
--
-- Indexes for table `master_cetak`
--
ALTER TABLE `master_cetak`
...
--
-- Indexes for table `master_instansi_distribusi`
--
ALTER TABLE `master_instansi_distribusi`
...
ALTER TABLE `master_publikasi`
  ...
  ADD KEY `penyusun` (`id_penyusun`),
  ADD KEY `bidang` (`id_bidang`);

--
-- Indexes for table `master_publikasi_non_arc`
--
ALTER TABLE `master_publikasi_non_arc`
  ADD PRIMARY KEY (`id_publikasi`);
...
--
-- Indexes for table `transaksi_download`
--
ALTER TABLE `transaksi_download`
  ADD PRIMARY KEY (`id_download_transaksi`),
  ADD KEY `transaksi` (`id_transaksi_publikasi`);
...
--
-- AUTO_INCREMENT for table `master_cetak`
--
ALTER TABLE `master_cetak`
  MODIFY `id_cetak` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `master_instansi_distribusi`
--
ALTER TABLE `master_instansi_distribusi`
...
--
-- Constraints for table `daftar_distribusi`
--
ALTER TABLE `daftar_distribusi`
  ADD CONSTRAINT `instansi` FOREIGN KEY (`id_instansi`) REFERENCES `master_instansi_distribusi` (`id_instansi`),
  ADD CONSTRAINT `publikasi` FOREIGN KEY (`id_publikasi`) REFERENCES `master_publikasi` (`id_publikasi`);

--
-- Constraints for table `login`
--
ALTER TABLE `login`
  ADD CONSTRAINT `pegawai` FOREIGN KEY (`id`) REFERENCES `master_pegawai` (`niplama`);

--
-- Constraints for table `master_publikasi`
--
ALTER TABLE `master_publikasi`
  ADD CONSTRAINT `bidang` FOREIGN KEY (`id_bidang`) REFERENCES `master_bidang` (`id_bidang`),
  ADD CONSTRAINT `penyusun` FOREIGN KEY (`id_penyusun`) REFERENCES `master_pegawai` (`niplama`);

--
-- Constraints for table `transaksi_download`
--
ALTER TABLE `transaksi_download`
  ADD CONSTRAINT `transaksi` FOREIGN KEY (`id_transaksi_publikasi`) REFERENCES `transaksi_publikasi` (`id_transaksi`);
COMMIT;
